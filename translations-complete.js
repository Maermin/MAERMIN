...
const completeTranslations = {
  en: {
    ...
    raTitle: 'Real Assets & Property', raAssets: 'assets', raNet: 'net', raIncomePa: 'income p.a.',
    raAdd: '+ Add Asset', raName: 'Name', raKind: 'Kind', raCurrency: 'Currency', raValue: 'Current value',
    raCost: 'Purchase price', raFees: 'Acquisition fees', raRent: 'Rent / month', raRunCost: 'Cost / month',
    raFinancing: 'Financing (liability)', raNoFinancing: 'None', raSave: 'Add', raCancel: 'Cancel',
    raNetYield: 'Net yield', raTotalReturn: 'Total return', raGross: 'Gross',
    raEmpty: 'No real assets yet. Add a property, vehicle or valuable to track its value, financing and rental cashflows.',
    interestSection: 'Interest (optional)', interestRate: 'Rate (% p.a.)', interestCompounding: 'Compounding',
    compDaily: 'Daily', compMonthly: 'Monthly', compAnnual: 'Annual',
    interestStartDate: 'Interest start', interestMaturity: 'Maturity date', interestPa: 'p.a.',
    ...
    exTitle: 'Exchange sync (read-only)', exSubtitle: 'Import crypto trades read-only. Use read-only API keys — keys are encrypted in your vault and never leave the device unencrypted.',
    exNeedKeys: 'Enter a read-only API key and secret.', exStored: 'Connection added. Keys encrypted in your vault.',
    ...
    caTitle: 'Corporate actions (splits)',
    caNone: 'No splits recorded for this holding.',
    caScan: 'Scan for splits',
    caScanning: 'Scanning…',
    caAdd: 'Add split',
    caRemove: 'Remove',
    caRemoveConfirm: 'Remove this split? It can be re-added or re-scanned.',
    caDate: 'Date',
    caNum: 'New',
    caDen: 'Old',
    caNotePh: 'Note (optional)',
    caAuto: 'auto',
    caReverse: 'reverse',
    caPreview: 'Detected splits — review, edit or skip, then confirm:',
    caConfirm: 'Add selected',
    caCancel: 'Cancel',
    caSkip: 'Skip',
    caKeep: 'Keep',
    caNoneFound: 'No new splits found (or the Worker has no split data).',
    caScanFail: 'Scan failed — enter splits manually.',
    caNoWorker: 'Add a Worker URL in API Settings to scan, or enter splits manually.',
    caBadDate: 'Enter a valid date (YYYY-MM-DD).',
    caBadRatio: 'Ratio must be two positive whole numbers.',
    caHint: 'Ratio New:Old — e.g. 10:1 forward, 1:10 reverse. Splits apply to lots before the date.',
  ...
  de: {
    ...
    raTitle: 'Sachwerte & Immobilien', raAssets: 'Sachwerte', raNet: 'netto', raIncomePa: 'Einnahmen p. a.',
    raAdd: '+ Sachwert', raName: 'Name', raKind: 'Art', raCurrency: 'Währung', raValue: 'Aktueller Wert',
    raCost: 'Kaufpreis', raFees: 'Kaufnebenkosten', raRent: 'Miete / Monat', raRunCost: 'Kosten / Monat',
    raFinancing: 'Finanzierung (Verbindlichkeit)', raNoFinancing: 'Keine', raSave: 'Hinzufügen', raCancel: 'Abbrechen',
    raNetYield: 'Nettorendite', raTotalReturn: 'Gesamtrendite', raGross: 'Brutto',
    raEmpty: 'Noch keine Sachwerte. Füge eine Immobilie, ein Fahrzeug oder einen Wertgegenstand hinzu, um Wert, Finanzierung und Miet-Cashflows zu verfolgen.',
    interestSection: 'Verzinsung (optional)', interestRate: 'Zinssatz (% p. a.)', interestCompounding: 'Zinseszins',
    compDaily: 'Täglich', compMonthly: 'Monatlich', compAnnual: 'Jährlich',
    interestStartDate: 'Zinsbeginn', interestMaturity: 'Fälligkeit', interestPa: 'p. a.',
    ...
    exTitle: 'Exchange-Sync (read-only)', exSubtitle: 'Krypto-Trades read-only importieren. Nur read-only-API-Keys verwenden — Keys werden im Vault verschlüsselt und verlassen das Gerät nie unverschlüsselt.',
    exNeedKeys: 'Read-only-API-Key und Secret eingeben.', exStored: 'Verbindung hinzugefügt. Keys im Vault verschlüsselt.',
    ...
    // Kapitalmaßnahmen (Aktiensplits)
    caTitle: 'Kapitalmaßnahmen (Splits)',
    caNone: 'Keine Splits für diese Position erfasst.',
    caScan: 'Nach Splits suchen',
    caScanning: 'Suche läuft …',
    caAdd: 'Split hinzufügen',
    caRemove: 'Entfernen',
    caRemoveConfirm: 'Diesen Split entfernen? Er kann erneut hinzugefügt oder gescannt werden.',
    caDate: 'Datum',
    caNum: 'Neu',
    caDen: 'Alt',
    caNotePh: 'Notiz (optional)',
    caAuto: 'auto',
    caReverse: 'Reverse',
    caPreview: 'Erkannte Splits — prüfen, bearbeiten oder überspringen, dann bestätigen:',
    caConfirm: 'Ausgewählte hinzufügen',
    caCancel: 'Abbrechen',
    caSkip: 'Überspringen',
    caKeep: 'Behalten',
    caNoneFound: 'Keine neuen Splits gefunden (oder der Worker liefert keine Split-Daten).',
    caScanFail: 'Suche fehlgeschlagen — Splits manuell eintragen.',
    caNoWorker: 'Hinterlege eine Worker-URL in den API-Einstellungen, oder trage Splits manuell ein.',
    caBadDate: 'Gültiges Datum eingeben (JJJJ-MM-TT).',
    caBadRatio: 'Verhältnis muss aus zwei positiven ganzen Zahlen bestehen.',
    caHint: 'Verhältnis Neu:Alt — z. B. 10:1 vorwärts, 1:10 reverse. Splits gelten für Lots vor dem Datum.'
  }
};
