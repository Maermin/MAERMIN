...
const VIEW_MODULES = [
  ...
  // v10 / v10.x feature modules (engines + their Views).
  { file: '../portfolio-snapshots.js', ns: 'MaerminSnapshots',  comps: ['normalize', 'addPoint', 'seriesFor', 'changeBetween', 'valueAsOf', 'record', 'prune'] },
  { file: '../tags.js',                ns: 'MaerminTags',       comps: ['View', 'normalize', 'aggregate', 'addTag', 'removeTag', 'assign', 'unassign', 'listTags', 'positionsFromInputs'] },
  { file: '../dashboard-layout.js',    ns: 'MaerminDashboard',  comps: ['View', 'normalize', 'visibleSet', 'visibleWidgets', 'toggle', 'move', 'reset'] },
  { file: '../performance-cards.js',   ns: 'MaerminPerformance', comps: ['View', 'computeAll', 'computePeriod', 'cleanSeries', 'dailyExtremes', 'seriesFromSnapshots'] },
  { file: '../rebalancing-planner.js', ns: 'MaerminRebalance',  comps: ['normalize', 'plan', 'setTarget', 'removeTarget', 'normalizeWeights', 'groupBy'] },
  { file: '../rules-engine.js',        ns: 'MaerminRules',      comps: ['View', 'normalize', 'evaluate', 'buildContext', 'describe', 'addRule', 'toggleRule'] },
  { file: '../custom-categories.js',   ns: 'MaerminCategories', comps: ['View', 'normalize', 'add', 'remove', 'rename', 'ids', 'all', 'label', 'color', 'slug'] },
];
...
const MUST_RENDER = [
  ...
  // v10.x Views — all are defensive (try/catch body, optional props), so they
  // render against representative AND empty data. Tags/Rules read the stubbed
  // transactions/prices; Performance/Dashboard/Categories read the stubbed
  // localStorage (empty) → exercise their empty-state paths.
  ['MaerminTags', 'View', baseProps],
  ['MaerminPerformance', 'View', baseProps],
  ['MaerminDashboard', 'View', baseProps],
  ['MaerminRules', 'View', baseProps],
  ['MaerminCategories', 'View', baseProps],
];
