...
(function run() {
  ...
  ok('non-renamed ticker passes through', T.normalizeForDividends('KO') === 'KO');
  ok('rename does not touch exchange-suffixed symbols', T.normalizeForDividends('SAP.DE') === 'SAP.DE');
